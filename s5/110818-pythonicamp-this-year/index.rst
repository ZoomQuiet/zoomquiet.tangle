...
2010~2011 `PythoniCamp <http://code.google.com/p/kcpycamp/wiki/PythoniCamp>`_

:作者: `Zoom.Quiet <zoomquiet+sns@gmai.com>`__
:URL:   http://zoomquiet.org/res/s5/110818-pythonicamp-this-year
...
.. container:: handout
    ...
    `PCAP2010-新加坡 <http://wiki.woodpecker.org.cn/moin/PyCon2010>`_ |zqeye|
...
.. container:: handout
    ...
    - `金山俱乐部高校列表 <http://code.google.com/p/kcpycamp/wiki/KcPyCampColleges>`_ |zqeye|
    - 录音超过 20小时
    - 录像超过 10小时
...
.. container:: handout
    ...
    多数现场, `备选项目 <http://code.google.com/p/kcpycamp/wiki/PythoniCampItems>`_ |zqeye|
...
.. container:: handout
    ...
    `导师索引 <http://code.google.com/p/kcpycamp/wiki/PythoniCampTutors>`_ |zqeye|
...
.. class:: incremental takahashi
    ...
    * 提前了必然的颠覆
    * 只能由自己改造自己
    * `InfoQ:技术如何拯救教育 <http://www.infoq.com/cn/articles/agile-schools-education>`_
...
:查阅:
    http://zoomquiet.org/res/s5/110818-pythonicamp-this-year
